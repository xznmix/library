...
<body>
    ...
    <div class="content-wrapper">
        ...
        <div class="judul-laporan">
            <h3>LAPORAN KEUANGAN DENDA PERPUSTAKAAN</h3>
            <p>Nomor: 421.3/{{ date('m/Y') }}/PIMPINAN/LAP-KEUANGAN</p>
        </div>
        ...
        <div class="summary">
            ...
            <table style="width: auto;">
                <tr><td><strong>Total Denda:</strong></td><td>Rp {{ number_format($totalDenda, 0, ',', '.') }}</td></tr>
                <tr><td><strong>Total Terbayar:</strong></td><td>Rp {{ number_format($totalTerbayar, 0, ',', '.') }}</td></tr>
                <tr><td><strong>Total Belum Bayar:</strong></td><td>Rp {{ number_format($totalBelumBayar, 0, ',', '.') }}</td></tr>
                <tr><td><strong>Persentase Terbayar:</strong></td><td>{{ number_format($persentaseTerbayar, 2) }}%</td></tr>
            </table>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @else
                            <span class="pending">Belum Bayar</span>
                        @endif
                    </td>
