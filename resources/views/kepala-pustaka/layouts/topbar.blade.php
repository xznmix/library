<header class="bg-white border-b border-gray-200 px-6 py-3 flex justify-between items-center">
    <div class="flex items-center">
        ...
        <h2 class="text-sm font-bold text-biru-600 uppercase tracking-tight">Halaman Kepala Pustaka</h2>
    </div>
    ...
    <div class="flex items-center space-x-4">
        ...
        {{-- Dark Mode Toggle --}}
        <button id="darkModeToggle" class="w-8 h-8 rounded-lg bg-gray-100 hover:bg-gray-200 text-hitam-600 flex items-center justify-center transition-colors">
        ...
        <div class="flex items-center space-x-3 pl-4 border-l border-gray-100">
            <div class="text-right hidden lg:block">
                ...
                <p class="text-[10px] text-hitam-500 uppercase">Kepala Pustaka</p>
            </div>
