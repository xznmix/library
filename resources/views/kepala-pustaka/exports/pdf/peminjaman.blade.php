...
<body>
    ...
    <div class="content-wrapper">
        ...
        <div class="info-tanggal">
            ...
            <p>Periode: Tahun {{ $tahun }}@if($bulan) - Bulan {{ \Carbon\Carbon::create()->month($bulan)->translatedFormat('F') }}@endif</p>
        </div>
        ...
        <div class="ringkasan">
            ...
            <div class="grid-ringkasan">
                <div class="item-ringkasan">
                    <span class="label">Total Peminjaman:</span> {{ $totalPeminjaman }} Transaksi
                </div>
                <div class="item-ringkasan">
                    <span class="label">Sedang Dipinjam:</span> {{ $data->where('status_pinjam', 'dipinjam')->count() }} Buku
                </div>
                <div class="item-ringkasan">
                    <span class="label">Selesai:</span> {{ $data->where('status_pinjam', 'dikembalikan')->count() }} Transaksi
                </div>
                <div class="item-ringkasan">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">{{ \Carbon\Carbon::parse($item->tgl_jatuh_tempo)->format('d/m/Y') }}</td>
                ...
                <tfoot>
                    <tr class="total-row">
                        <td colspan="7" style="text-align: right;"><strong>TOTAL DENDA:</strong></td>
        ...
        <div class="keterangan">
            ...
            <ul>
                <li>Laporan ini dibuat berdasarkan data peminjaman periode tahun {{ $tahun }}@if($bulan) bulan {{ \Carbon\Carbon::create()->month($bulan)->translatedFormat('F') }}@endif</li>
                <li>Status "TERLAMBAT" menandakan buku belum dikembalikan melebihi batas waktu yang ditentukan</li>
                <li>Denda akan dikenakan jika terjadi keterlambatan atau kerusakan buku</li>
            </ul>
        </div>
